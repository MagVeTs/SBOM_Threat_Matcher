...
SBOM Threat Matcher can be paired with the following Bash script in order to progromatically check all the repositories in an entire GitHub organization or account for vulnerable dependencies: https://github.com/MagVeTs/scan_github_org_dependencies.
